...
class PhotoGridListDemo extends StatefulWidget {
  const PhotoGridListDemo({Key key}) : super(key: key);

  static const String routeName = '/material/grid-list';

  @override
  PhotoGridListDemoState createState() => new PhotoGridListDemoState();
}

class PhotoGridListDemoState extends State<PhotoGridListDemo> {
  ...
  List<Photo> photos = <Photo>[
    ...
    new Photo(
      assetName: 'assets/images/pic4.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'A place',
      caption: 'Beautiful hills',
    ),
    new Photo(
      assetName: 'assets/images/pic5.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'Autumn',
      caption: 'The golden season',
    ),
    new Photo(
      assetName: 'assets/images/pic6.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'Germany',
      caption: 'Englischer Garten',
    ),
    new Photo(
      assetName: 'assets/images/pic7.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'A country',
      caption: 'Grass fields',
    ),
    new Photo(
      assetName: 'assets/images/pic8.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'Mountain country',
      caption: 'River forest',
    ),
    new Photo(
      assetName: 'assets/images/pic9.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'Alpine place',
      caption: 'Green hills',
    ),
    new Photo(
      assetName: 'assets/images/pic10.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'Desert land',
      caption: 'Blue skies',
    ),
    new Photo(
      assetName: 'assets/images/pic11.jpg',
      assetPackage: _kGalleryAssetsPackage,
      title: 'Narnia',
